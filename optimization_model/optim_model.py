...
def run_optim(devs, param, dem, result_dict, calc_id, flags):
    ...
    if model.Status in (3, 4) or model.SolCount == 0:  # "INFEASIBLE" or "INF_OR_UNBD"
        ...
        ### WRITE EXCEL FILE ###
        create_excel_file.create_excel_file(full, dem, devs, calc_id, time_steps, days)
